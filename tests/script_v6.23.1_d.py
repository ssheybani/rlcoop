...
#     nn_mod1._log_weights = nn_mod1._log_params #@@@@@@@@@@@ Monitor parameters
    ...
    #---------------------------------
    # Init agents
    dirname = DATA_PATH+'/Mar22_6.23.1_2/cp0.05cn0.3/'
    fname = 'script_v6.23.1.pycp0.05cn0.3_16.43.11-0999'
...
if clean_exit is False:
    ...
    try:
        ...
        pass
    fname = exp_name+run_token+'-'+'{:04d}'.format(i*int_episodes+j)
    pickle.dump((x, [yp,yc1, yc2], agent1, agent2), open( DATA_PATH+data_subdir+fname, "wb" ) )
