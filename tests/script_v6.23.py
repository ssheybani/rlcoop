...
parent_path = '../'
sys.path.append(parent_path+'configs/')
sys.path.append(parent_path+'agents/')
sys.path.append(parent_path+'algos/')
sys.path.append(parent_path+'util/')
sys.path.append(parent_path+'envs/')
...
#     actor1_opt = optim.Adam([
#             {'params': actor_net1.fc_mu.parameters(), 'lr': lr, 'weight_decay': 0.1*wd},
#             {'params': actor_net1.fc1.parameters(), 'lr': 10*lr, 'weight_decay': 10*wd}
